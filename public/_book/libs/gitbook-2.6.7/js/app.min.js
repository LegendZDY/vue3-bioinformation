...
})(
  {
      ...
      function (require, module, exports) {
        ;(function (window, document, undefined) {
          ...
          function _getKeyInfo(combination, action) {
            ...
            return { key: key, modifiers: modifiers, action: action }
          }
    ...
    13: [
      function (require, module, exports) {
        ...
        var MODULES = { gitbook: gitbook, jquery: $, lodash: _ }
    ...
    14: [
      function (require, module, exports) {
        ...
        module.exports = { init: init, bind: bindShortcut }
      },
      { './navigation': 16, './sidebar': 18, mousetrap: 3 },
    ],
    15: [
      function (require, module, exports) {
        var state = require('./state')
    ...
    16: [
      ...
      { './events': 12, './loading': 15, './state': 19, jquery: 1, url: 10 },
    ],
    17: [
      function (require, module, exports) {
        module.exports = {
      ...
      function (require, module, exports) {
        ...
        state.update = function (dom) {
          ...
          state.root = url
            ...
            .replace(/\/?$/, '/')
          state.bookRoot = state.innerLanguage
            ? url.resolve(state.root, '..')
            : state.root
        }
        state.update($)
        module.exports = state
      },
      { jquery: 1, path: 4, url: 10 },
    ],
    20: [
      function (require, module, exports) {
        var baseKey = ''
    ...
    21: [
      function (require, module, exports) {
        ...
        function insertAt(parent, selector, index, element) {
          ...
          if (index < lastIndex) {
            parent
              .children(selector)
              .eq(index)
              .before(parent.children(selector).last())
          }
        }
        ...
        function updateButton(opts) {
          ...
          if (opts.icon) {
            $('<i>', { class: opts.icon }).prependTo($btn)
          }
          if (opts.dropdown) {
            var $container = $('<div>', {
            ...
            $menu.addClass(
              'dropdown-' + (opts.position == 'right' ? 'left' : 'right'),
            )
